...
// fallback: true
// ※ 事前にビルドしてないパスにアクセスされても404にしない

// 【事前にビルドしていないパスへアクセスしたときのフロー】
// 1, useRouterを使い一時的にpageのfallbackバージョンを表示させる
// 2, getStaticPropsがサーバー側で実行され静的なファイルを生成する
// 3, 生成が完了したらfallbackバージョンから切り替える
// 4, 以後のリクエストに対しては事前にビルドしたページと同じように静的なファイルを返す
