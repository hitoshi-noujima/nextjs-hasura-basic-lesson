...
import { GetUsersQuery, CreateUserMutation, DeleteUserMutation, UpdateUserMutation } from '../types/generated/graphql'
...
const HasuraCRUD: VFC = () => {
  ...
  if (error) return (
    <Layout title="Hasura CRUD">Error: {error.message}</Layout>
  )
